...
var Util = require('../../util/util'),
    MTools = require('../matrix-tools'),
    Matrix = require('../../math/matrix'),
    Norm = require('../../math/norm'),
    DC = require('../../math/decompositions'),
    ATools = require('../array-tools'),
    MLR = require('../models/regression/multivariate-linear-regression');
...
module.exports = PartialLeastSquaresAnalysis;